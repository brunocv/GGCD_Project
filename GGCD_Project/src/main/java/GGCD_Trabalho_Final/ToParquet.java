...
public class ToParquet {
    ...
    public static Schema getSchema(String str) throws IOException {
    ...
    public static class JoinReducer extends Reducer<Text,Text, Void, GenericRecord> {
        ...
        protected void setup(Context context) throws IOException, InterruptedException {
            schema = getSchema("hdfs:///schema.movies");
        }
    ...
    public static void main(String[] args) throws Exception{
        ...
        AvroParquetOutputFormat.setSchema(job1, getSchema("hdfs:///schema.movies"));
