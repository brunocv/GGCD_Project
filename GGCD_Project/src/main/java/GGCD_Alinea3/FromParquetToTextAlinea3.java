...
public class FromParquetToTextAlinea3 {
    ...
    public static void main(String args[]) throws Exception{
        ...
        AvroParquetInputFormat.addInputPath(job_1,new Path("resultado_parquet"));
        Schema schema;
        schema = getSchema("schema.alinea3");
        AvroParquetInputFormat.setRequestedProjection(job_1, schema);

        job_1.setOutputFormatClass(TextOutputFormat.class);
        TextOutputFormat.setOutputPath(job_1,new Path("resultado_from_parquet_alinea3_fase1"));
        ...
        AvroParquetInputFormat.addInputPath(job_2,new Path("resultado_parquet"));
